...
print(durations)
durations.plot(kind="line", x="year")
...
# # # Fig 1 Incidence
# seaborn.lineplot(x="year", y='females_12_17', data=inc, color=colors[0], linestyle="solid", label="F 12-17")
# seaborn.lineplot(x="year", y='males_12_17', data=inc, color=colors[3], linestyle="solid", label="M 12-17")
# seaborn.lineplot(x="year", y='females_0_11', data=inc, color=colors[2], linestyle="solid", label="F 0-11")
# seaborn.lineplot(x="year", y='males_0_11', data=inc, color=colors[4], linestyle="solid", label="M 0-11")
# plt.ylim([0, 120])
